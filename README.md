...
**Description:**  
A console-based application designed to manage student records efficiently using object-oriented design principles.
...
### Algorithm / DSA-Based Project
**Technologies:** C++, Data Structures & Algorithms  

**Description:**  
A logic-oriented project demonstrating the implementation and behavior of fundamental algorithms.

**Key Features:**
- Implementation of core algorithms (e.g., sorting or path-finding)  
...
**Description:**  
A responsive and minimal personal portfolio website designed to present skills, projects, and coding profiles in a recruiter-friendly format.
...
- Present an honest and professional student profile  
- Showcase foundational programming and problem-solving skills  
- Support internship applications and technical interviews  
- Demonstrate readiness to learn and grow as a software engineer  
